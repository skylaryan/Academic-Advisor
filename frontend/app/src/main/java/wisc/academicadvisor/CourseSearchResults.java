...
public class CourseSearchResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            resultsTitle.setText(ja_Courses.size() + " Course Search Results\n" +
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                while ((line = rd.readLine()) != null)
                    jsResponse += line + "\n";
                ja_Courses = (JSONArray) parser.parse(jsResponse);
                final TextView resultsTitle = (TextView) findViewById(R.id.resultsTitle);
                resultsTitle.post(new Runnable() {
